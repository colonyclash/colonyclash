...
const TRANSLATIONS = {
  pt: {
    ...
    no_members_found: "Sem membros.",
    no_clan_found: "Nenhum clã encontrado.",
    already_member: "JÁ É MEMBRO",
    join_clan: "ENTRAR NO CLÃ",
    add_friend_btn: "ADICIONAR",
    friends_empty: "Sua lista de amigos está vazia.",
    friend_label: "Amigo",
    current_label: "ATUAL",
    attack_limit: "Limite de ataques atingido!",
    attack_limit_info: "Você pode fazer 5 ataques por hora.",
    next_attack_in: "Próximo ataque em",
    searching_opponent: "Procurando oponente...",
    firebase_not_configured: "Configure o Firebase para jogar online!",
    insufficient_energy_detail: "Energia insuficiente para buscar (10 necessária)",
    buildings_label: "construções",
    tutorial_restarted: "Tutorial reiniciado!",
    new_tech: "Novas tecnologias",
    max_building_level: "Nív. Máx Edifícios",
    barracks_max: "Quartel Máx",
    you_label: "Você"
  },
  en: {
    lang_name: "English",
    ...
    no_members_found: "No members.",
    no_clan_found: "No clans found.",
    already_member: "ALREADY MEMBER",
    join_clan: "JOIN CLAN",
    add_friend_btn: "ADD",
    friends_empty: "Your friends list is empty.",
    friend_label: "Friend",
    current_label: "CURRENT",
    attack_limit: "Attack limit reached!",
    attack_limit_info: "You can make 5 attacks per hour.",
    next_attack_in: "Next attack in",
    searching_opponent: "Searching for opponent...",
    firebase_not_configured: "Configure Firebase to play online!",
    insufficient_energy_detail: "Insufficient energy to search (10 required)",
    buildings_label: "buildings",
    tutorial_restarted: "Tutorial restarted!",
    new_tech: "New technologies",
    max_building_level: "Max Building Level",
    barracks_max: "Barracks Max",
    you_label: "You"
  },
  es: {
    lang_name: "Español",
    ...
    no_members_found: "Sin miembros.",
    no_clan_found: "No se encontraron clanes.",
    already_member: "YA ES MIEMBRO",
    join_clan: "UNIRSE AL CLAN",
    add_friend_btn: "AÑADIR",
    friends_empty: "Tu lista de amigos está vacía.",
    friend_label: "Amigo",
    current_label: "ACTUAL",
    attack_limit: "¡Límite de ataques alcanzado!",
    attack_limit_info: "Puedes hacer 5 ataques por hora.",
    next_attack_in: "Próximo ataque en",
    searching_opponent: "Buscando oponente...",
    firebase_not_configured: "¡Configura Firebase para jugar en línea!",
    insufficient_energy_detail: "Energía insuficiente para buscar (10 requerida)",
    buildings_label: "edificios",
    tutorial_restarted: "¡Tutorial reiniciado!",
    new_tech: "Nuevas tecnologías",
    max_building_level: "Nivel Máx. Edificios",
    barracks_max: "Cuartel Máx",
    you_label: "Tú"
  },
};
