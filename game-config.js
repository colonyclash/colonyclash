...
const ROULETTE_PRIZES = [
  { id: 0, type: 'mineral', amount: 1200, weight: 20, label: "1.200 Minério", icon: 'mineral_icon.svg', color: '#00D4FF' },
  { id: 1, type: 'oxygen',  amount: 1000, weight: 20, label: "1.000 Oxigênio", icon: 'oxygen_icon.svg', color: '#2ecc71' },
  { id: 2, type: 'energy',  amount: 700,  weight: 20, label: "700 Energia", icon: 'energy_icon.svg', color: '#f1c40f' },
  { id: 3, type: 'gems',    amount: 3,    weight: 15, label: "3 Gemas", icon: 'gems_icon.svg', color: '#e74c3c' },
  { id: 4, type: 'shield',  amount: 2,    weight: 15, label: "Escudo 2h", icon: 'shield.png', color: '#3498db' },
  { id: 5, type: 'gems',    amount: 8,    weight: 8,  label: "8 Gemas", icon: 'gems_icon.svg', color: '#9b59b6' },
  { id: 6, type: 'gems',    amount: 50,   weight: 2,  label: "50 Gemas", icon: 'gems_icon.svg', color: '#FFD700' }
];
