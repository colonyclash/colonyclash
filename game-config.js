...
const BUILDINGS = {
  command_center: {
    ...
    levels: [null,
      {
        hp: 1000, buildTime: 10, cost: { mineral: 0, oxygen: 0 },
      ...
      {
        hp: 2000, buildTime: 900, cost: { mineral: 5000, oxygen: 2500 },
      ...
      {
        hp: 3000, buildTime: 1800, cost: { mineral: 15000, oxygen: 8000 },
      ...
      {
        hp: 4000, buildTime: 3600, cost: { mineral: 25000, oxygen: 25000 },
...
const TRANSLATIONS = {
  pt: {
    ...
    tutorial_step6: "No CC nível 3 o Laboratório é desbloqueado — pesquise melhorias de tropas com <img src=\"energy_icon.svg\" class=\"inline-icon\"> Energia.",
    ...
    mission_19: "CONTRATAR O SEGUNDO ASTRONAUTA CONSTRUTOR",
    next: "Próximo",
    ready: "pronto",
    ...
    new_builder_hired: "Novo astronauta contratado! <img src=\"astronaut_builder.svg\" class=\"inline-icon\">",
    ...
    confirm_reset_tutorial: "Deseja realmente reiniciar o tutorial?",
    production: "Produção",
    damage: "Dano",
    range: "Alcance",
    end_battle: "RECUAR",
    ...
    waiting: "EM ESPERA",
    attack_label: "ATACAR",
    tut_step0: "Bem‑vindo, Comandante! Vou te guiar nos primeiros passos.",
    tut_step1: "Clique no botão de Construir (+).",
    tut_step2: "Agora selecione o 'Extrator de Minério'.",
    tut_step3: "Escolha um local na grade e confirme clicando no ✔.",
    tut_step4: "Clique no prédio que você acabou de colocar.",
    tut_step5: "Clique em 'ACELERAR' para terminar a construção instantaneamente usando Gemas!",
    tut_step6: "Agora precisamos de Oxigênio. Clique no botão de Construir (+).",
    tut_step7: "Selecione o 'Extrator de Oxigênio'.",
    tut_step8: "Para treinar tropas, precisamos de um Quartel. Clique em Construir (+).",
    tut_step9: "Selecione o 'Quartel'.",
    tut_step10: "Para abrigar tropas, precisamos de um Acampamento. Clique em Construir (+).",
    tut_step11: "Selecione o 'Acampamento'.",
    tut_step12: "Ótimo! Agora vamos treinar tropas. Clique no ícone de Tropas.",
    tut_step13: "Treine 8 Drones para o seu exército.",
    tut_step14: "Parabéns, Comandante! Você concluiu o treinamento básico. Verifique as MISSÕES para continuar progredindo.",
    tut_finish: "Finalizar Tutorial",
    daily_streak: "Daily Streak",
    claim_daily: "RESGATAR RECOMPENSA DIÁRIA",
    streak_reset: "Streak reiniciado!",
    streak_day: "Dia {day}",
    streak_claimed: "Recompensa de hoje resgatada!",
    streak_tomorrow: "Volte amanhã para o Dia {day}!",
    streak_info: "Entre todos os dias para ganhar recompensas maiores! Se falhar um dia, o progresso reseta.",
    roulette_title: "ROLETA LUNAR",
    roulette_spin: "GIRAR",
    roulette_free: "GIRO GRÁTIS!",
    roulette_cost: "GIRAR POR 5 💎",
    roulette_wait: "Aguarde {time}",
    roulette_won: "Você ganhou: {prize}!",
    shield_2h: "Escudo 2h",
    clan: "Clã",
    positioning: "Posicionando...",
    clan_chat_locked: "Chat do clã bloqueado!",
    firebase_not_set: "Firebase não configurado.",
    already_in_clan: "Você já está em um clã!",
    clan_cost_mineral: "Minério insuficiente! (Custo: 1.000 <img src=\"mineral_icon.svg\" class=\"inline-icon\">)",
    creating_clan: "Criando clã...",
    clan_creation_error: "Erro na criação do clã.",
    already_friend: "Já é seu amigo!",
    access_blocked_cc4: "Acesso bloqueado! Requer CC Nível 4 e Torre do Clã construída.",
    uid_copied: "UID copiado para a área de transferência!"
  },
  en: {
    lang_name: "English",
    loading: "Loading",
    ...
    tutorial_step6: "At CC level 3 the Laboratory is unlocked — research troop upgrades with <img src=\"energy_icon.svg\" class=\"inline-icon\"> Energy.",
    ...
    mission_19: "HIRE THE SECOND ASTRONAUT BUILDER",
    next: "Next",
    ready: "ready",
    ...
    new_builder_hired: "New astronaut hired! <img src=\"astronaut_builder.svg\" class=\"inline-icon\">",
    ...
    confirm_reset_tutorial: "Do you really want to restart the tutorial?",
    ...
    waiting: "WAITING",
    attack_label: "ATTACK",
    tut_step0: "Welcome, Commander! I will guide you through the first steps.",
    tut_step1: "Click the Build button (+).",
    tut_step2: "Now select the 'Mineral Extractor'.",
    tut_step3: "Choose a location on the grid and confirm by clicking ✔.",
    tut_step4: "Click on the building you just placed.",
    tut_step5: "Click 'SPEED UP' to finish construction instantly using Gems!",
    tut_step6: "Now we need Oxygen. Click the Build button (+).",
    tut_step7: "Select the 'Oxygen Extractor'.",
    tut_step8: "To train troops, we need a Barracks. Click Build (+).",
    tut_step9: "Select the 'Barracks'.",
    tut_step10: "To house troops, we need a Camp. Click Build (+).",
    tut_step11: "Select the 'Camp'.",
    tut_step12: "Great! Now let's train troops. Click the Troops icon.",
    tut_step13: "Train 8 Drones for your army.",
    tut_step14: "Congratulations, Commander! You have completed the basic training. Check the MISSIONS to continue progressing.",
    tut_finish: "Finish Tutorial",
    daily_streak: "Daily Streak",
    claim_daily: "CLAIM DAILY REWARD",
    streak_reset: "Streak reset!",
    streak_day: "Day {day}",
    streak_claimed: "Today's reward claimed!",
    streak_tomorrow: "Come back tomorrow for Day {day}!",
    streak_info: "Log in every day to earn bigger rewards! If you miss a day, progress resets.",
    roulette_title: "LUNAR ROULETTE",
    roulette_spin: "SPIN",
    roulette_free: "FREE SPIN!",
    roulette_cost: "SPIN FOR 5 💎",
    roulette_wait: "Wait {time}",
    roulette_won: "You won: {prize}!",
    shield_2h: "2h Shield",
    clan: "Clan",
    positioning: "Positioning...",
    clan_chat_locked: "Clan chat locked!",
    firebase_not_set: "Firebase not configured.",
    already_in_clan: "You are already in a clan!",
    clan_cost_mineral: "Insufficient minerals! (Cost: 1,000 <img src=\"mineral_icon.svg\" class=\"inline-icon\">)",
    creating_clan: "Creating clan...",
    clan_creation_error: "Clan creation error.",
    already_friend: "Already your friend!",
    access_blocked_cc4: "Access blocked! Requires CC Level 4 and Clan Tower built.",
  ...
  es: {
    ...
    mission_16: "CONSTRUIR 1 CAMPAMENTO",
    mission_17: "ENTRENAR 1 DRONE",
    mission_18: "DESTRUIR 1 EDIFICIO ENEMIGO",
    mission_19: "CONTRATAR AL SEGUNDO ASTRONAUTA CONSTRUCTOR",
    next: "Siguiente",
    ready: "listo",
    ...
    new_builder_hired: "¡Nuevo astronauta contratado! <img src=\"astronaut_builder.svg\" class=\"inline-icon\">",
    ...
    reset_tutorial: "REINICIAR TUTORIAL",
    confirm_reset_tutorial: "¿Deseas realmente reiniciar el tutorial?",
    ...
    waiting: "EN ESPERA",
    attack_label: "ATACAR",
    tut_step0: "¡Bienvenido, Comandante! Te guiaré en los primeros pasos.",
    tut_step1: "Haz clic en el botón de Construir (+).",
    tut_step2: "Ahora selecciona el 'Extractor de Mineral'.",
    tut_step3: "Elige un lugar en la cuadrícula y confirma haciendo clic en el ✔.",
    tut_step4: "Haz clic en el edificio que acabas de colocar.",
    tut_step5: "¡Haz clic en 'ACELERAR' para terminar la construcción al instante usando Gemas!",
    tut_step6: "Ahora necesitamos Oxígeno. Haz clic en el botón de Construir (+).",
    tut_step7: "Selecciona el 'Extractor de Oxígeno'.",
    tut_step8: "Para entrenar tropas, necesitamos un Cuartel. Haz clic en Construir (+).",
    tut_step9: "Selecciona el 'Cuartel'.",
    tut_step10: "Para albergar tropas, necesitamos un Campamento. Haz clic en Construir (+).",
    tut_step11: "Selecciona el 'Campamento'.",
    tut_step12: "¡Genial! Ahora vamos a entrenar tropas. Haz clic en el icono de Tropas.",
    tut_step13: "Entrena 8 Drones para tu ejército.",
    tut_step14: "¡Felicidades, Comandante! Has completado el entrenamiento básico. Revisa las MISIONES para seguir progresando.",
    tut_finish: "Finalizar Tutorial",
    daily_streak: "Racha Diaria",
    claim_daily: "RECLAMAR RECOMPENSA DIARIA",
    streak_reset: "¡Racha reiniciada!",
    streak_day: "Día {day}",
    streak_claimed: "¡Recompensa de hoy reclamada!",
    streak_tomorrow: "¡Vuelve mañana para el Día {day}!",
    streak_info: "¡Entra todos los días para ganar recompensas mayores! Si fallas un día, el progreso se reinicia.",
    roulette_title: "RULETA LUNAR",
    roulette_spin: "GIRAR",
    roulette_free: "¡GIRO GRATIS!",
    roulette_cost: "GIRAR POR 5 💎",
    roulette_wait: "Espera {time}",
    roulette_won: "¡Ganaste: {prize}!",
    shield_2h: "Escudo 2h",
    clan: "Clan",
    positioning: "Posicionando...",
    clan_chat_locked: "¡Chat del clan bloqueado!",
    firebase_not_set: "Firebase no configurado.",
    already_in_clan: "¡Ya estás en un clan!",
    clan_cost_mineral: "¡Minerales insuficientes! (Costo: 1.000 <img src=\"mineral_icon.svg\" class=\"inline-icon\">)",
    creating_clan: "Creando clan...",
    clan_creation_error: "Error en la creación del clan.",
    already_friend: "¡Ya es tu amigo!",
    access_blocked_cc4: "¡Acceso bloqueado! Requiere CC Nivel 4 y Torre del Clan construida.",
    uid_copied: "¡UID copiado al portapapeles!"
  },
};
...
const DAILY_REWARDS = [
  { type: 'mineral', amount: 1500, icon: 'mineral_icon.svg' },
  { type: 'oxygen',  amount: 1200, icon: 'oxygen_icon.svg' },
  { type: 'energy',  amount: 800,  icon: 'energy_icon.svg' },
  { type: 'gems',    amount: 5,    icon: 'gems_icon.svg' },
  { type: 'mineral', amount: 3000, icon: 'mineral_icon.svg' },
  { type: 'oxygen',  amount: 2500, icon: 'oxygen_icon.svg' },
  { type: 'gems',    amount: 15,   icon: 'gems_icon.svg' },
  { type: 'energy',  amount: 1800, icon: 'energy_icon.svg' },
  { type: 'mineral', amount: 5000, icon: 'mineral_icon.svg' },
  { type: 'oxygen',  amount: 4000, icon: 'oxygen_icon.svg' },
  { type: 'energy',  amount: 3000, icon: 'energy_icon.svg' },
  { type: 'gems',    amount: 25,   icon: 'gems_icon.svg' },
  { type: 'mineral', amount: 8000, icon: 'mineral_icon.svg' },
  { type: 'oxygen',  amount: 7000, icon: 'oxygen_icon.svg' },
  { type: 'gems',    amount: 50,   icon: 'gems_icon.svg' }
];

const ROULETTE_PRIZES = [
  { id: 0, type: 'mineral', amount: 1200, weight: 20, get label() { return `1.200 ${t('mineral')}`; }, icon: 'mineral_icon.svg', color: '#00D4FF' },
  { id: 1, type: 'oxygen',  amount: 1000, weight: 20, get label() { return `1.000 ${t('oxygen')}`; },  icon: 'oxygen_icon.svg', color: '#2ecc71' },
  { id: 2, type: 'energy',  amount: 700,  weight: 20, get label() { return `700 ${t('energy')}`; },   icon: 'energy_icon.svg', color: '#f1c40f' },
  { id: 3, type: 'gems',    amount: 3,    weight: 15, get label() { return `3 ${t('gems_unit')}`; },  icon: 'gems_icon.svg', color: '#e74c3c' },
  { id: 4, type: 'shield',  amount: 2,    weight: 15, get label() { return t('shield_2h'); },          icon: 'shield.png', color: '#3498db' },
  { id: 5, type: 'gems',    amount: 8,    weight: 8,  get label() { return `8 ${t('gems_unit')}`; },  icon: 'gems_icon.svg', color: '#9b59b6' },
  { id: 6, type: 'gems',    amount: 50,   weight: 2,  get label() { return `50 ${t('gems_unit')}`; }, icon: 'gems_icon.svg', color: '#FFD700' }
];
