...
const TRANSLATIONS = {
  pt: {
    ...
    tut_step1: "Primeiro, precisamos de Minério. Clique no botão de Construir (+).",
    tut_step2: "Excelente! Agora selecione o 'Extrator de Minério'.",
    tut_step3: "Escolha um local na grade e confirme clicando no ✔.",
    tut_step4: "A construção demora um pouco. Clique no prédio que você acabou de colocar.",
    ...
    tut_step9: "Para treinar tropas, precisamos de um Quartel. Clique em Construir (+).",
    tut_step10: "Selecione o 'Quartel'.",
    tut_step12: "Para abrigar tropas, precisamos de um Acampamento. Clique em Construir (+).",
    tut_step13: "Selecione o 'Acampamento'.",
    tut_step15: "Ótimo! Agora vamos treinar tropas. Clique no ícone de Tropas.",
    tut_step16: "Treine 3 Drones para o seu exército.",
    tut_step17: "Suas tropas estão prontas! Clique na aba 'TROPAS' para vê-las.",
    tut_step18: "Exército pronto! Vamos testar seu poder. Clique no botão de Ataque.",
    tut_step19: "Oponente encontrado! Clique em 'ATACAR!' para iniciar a invasão.",
    tut_step20: "Vença a batalha para provar seu valor!",
    tut_step21: "Parabéns, Comandante! Você concluiu o treinamento básico. Verifique as MISSÕES para continuar progredindo.",
  ...
  en: {
    ...
    tut_step1: "First, we need Ore. Click the Build button (+).",
    tut_step2: "Excellent! Now select the 'Mineral Extractor'.",
    tut_step3: "Choose a location on the grid and confirm by clicking ✔.",
    tut_step4: "Construction takes some time. Click on the building you just placed.",
    ...
    tut_step9: "To train troops, we need a Barracks. Click Build (+).",
    tut_step10: "Select the 'Barracks'.",
    tut_step12: "To house troops, we need a Camp. Click Build (+).",
    tut_step13: "Select the 'Camp'.",
    tut_step15: "Great! Now let's train troops. Click the Troops icon.",
    tut_step16: "Train 3 Drones for your army.",
    tut_step17: "Your troops are ready! Click the 'TROOPS' tab to see them.",
    tut_step18: "Army ready! Let's test your power. Click the Attack button.",
    tut_step19: "Opponent found! Click 'ATTACK!' to start the invasion.",
    tut_step20: "Win the battle to prove your worth!",
    tut_step21: "Congratulations, Commander! You have completed the basic training. Check the MISSIONS to continue progressing.",
